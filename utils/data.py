...
class Data:
    ...
    def build_position_pretrain_emb(self, emb_path):
        print("build position pretrain emb...")
        self.posi_alphabet_size += 1
        self.pretrain_posi_embedding, self.posi_emb_dim = build_embedding(emb_path, self.posi_alphabet_size, self.posi_emb_dim)
